...
pub async fn get_settings(
    ...
    let app_name =
        crate::services::settings::get(&mut conn, "app_name").await.unwrap_or_else(|_| "Helm Hub".into());
    let logo_url = crate::services::settings::get(&mut conn, "logo_url").await.unwrap_or_default();
